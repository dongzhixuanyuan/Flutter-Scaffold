class Api {
  ...
  //评价请求接口
  static const String SetInsertEvaluate =
      BaseUrl + "insertevaluate/json.action";
  ...
  //查询用户头像请求接口
  static const String SetSelectImage = BaseUrl + "selectimage/json.action";

  //用户头像获得接口
  static const String GetSelectImage = BaseTomcatUrl + "userimage.json";
}
