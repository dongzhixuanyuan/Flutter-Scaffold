...
class Toast {
  ...
  static void show(String msg, BuildContext context,
      {int duration = 1,
        ...
        Border border, EdgeInsetsGeometry margin = null, EdgeInsetsGeometry padding = null}) {
    ToastView.dismiss();
...
class ToastView {
  ...
  static void createView(String msg, BuildContext context, int duration,
      int gravity,
      Color background, Color textColor, double backgroundRadius, Border border,
      {EdgeInsetsGeometry margin = null, EdgeInsetsGeometry padding = null}) async {
